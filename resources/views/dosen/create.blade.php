                    ...
                    <div class="card-body">
                        <form action="{{ route('dosen.store') }}" method="POST" enctype="multipart/form-data">
                            ...
                            <div class="form-group">
                                ...
                                name="nidn" value="{{ old('nim') }}" placeholder="Masukkan NIDN">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control @error('jns_kelamin') is-invalid @enderror" 
                                name="jns_kelamin" value="{{ old('jurusan') }}" placeholder="Masukkan nama jenis kelamin">
